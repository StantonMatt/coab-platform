      ...
      try {
        const body = z
          .object({
            ...
            fechaCambio: z.string().optional(), // ISO date string, defaults to current date
          })
          .parse(request.body);
      ...
      try {
        const body = z
          .object({
            ...
            fechaCambio: z.string(), // ISO date string for the last month of old subsidy
          })
          .parse(request.body);
      ...
      try {
        const body = z
          .object({
            ...
            fechaCambio: z.string().optional(), // ISO date string (last day of month)
          })
          .parse(request.body);
