      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link to="/admin/boletas/generar">
            <Card className="hover:shadow-md transition-shadow cursor-pointer border-2 border-transparent hover:border-emerald-200">
              <CardHeader className="pb-2">
              ...
              <CardContent>
                <CardTitle className="text-lg text-slate-800">Generar PDFs</CardTitle>
                <p className="text-sm text-slate-600 mt-1">
                  Boletas en lote
                </p>
              </CardContent>
